...
const SessionConfig = ({ onStartSession }) => {
    ...
    // Effet pour le lien des participants
    useEffect(() => {
            ...
            if (type === 'tdr') {
                ...
                reader.onload = (e) => {
                    try {
                        ...
                        setTotalParticipants(lines.length - 1);
                    } catch (error) {
    ...
    const handleToolSelection = (toolId) => {
        console.log("Selecting tool:", toolId); // Debug
    ...
    // Gestion des changements de participants
    ...
    // Gestion des changements de tables
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log("Submitting session config with data:", {
            projectName,
            totalParticipants,
